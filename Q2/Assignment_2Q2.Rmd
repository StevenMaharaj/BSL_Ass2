...
gelman.diag(estml)[[1]]
```
The graphical summaries ensure that chain converge to the same distribution. The Gelman-Rubin diagnostics for all parameters are very close to one so all thus chains mixed sufficiently.
